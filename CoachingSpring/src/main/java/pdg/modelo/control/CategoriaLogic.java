...
*/
@Scope("singleton")
@Service("CategoriaLogic")
public class CategoriaLogic implements ICategoriaLogic {
    private static final Logger log = LoggerFactory.getLogger(CategoriaLogic.class);
    ...
    */
    ...
    public List<Categoria> getCategoria() throws Exception {
        ...
        try {
            ...
            log.error("finding all Categoria failed", e);
    ...
    public void saveCategoria(Categoria entity) throws Exception {
        ...
        try {
            if (entity == null) {
                throw new ZMessManager().new NullEntityExcepcion("Categoria");
            }

            validateCategoria(entity);

            if (getCategoria(entity.getIdCat()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            categoriaDAO.save(entity);
            log.debug("save Categoria successful");
        } catch (Exception e) {
            log.error("save Categoria failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void deleteCategoria(Categoria entity) throws Exception {
        ...
        try {
            coaches = coachDAO.findByProperty("categoria.idCat",
                    entity.getIdCat());
    ...
    public void updateCategoria(Categoria entity) throws Exception {
        ...
        try {
            ...
            log.debug("update Categoria successful");
        } catch (Exception e) {
            log.error("update Categoria failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public List<CategoriaDTO> getDataCategoria() throws Exception {
        try {
            ...
            for (Categoria categoriaTmp : categoria) {
                CategoriaDTO categoriaDTO2 = categoriaMapper.categoriaToCategoriaDTO(categoriaTmp);
                categoriaDTO.add(categoriaDTO2);
            }
    ...
    public Categoria getCategoria(Double idCat) throws Exception {
        ...
        try {
            entity = categoriaDAO.findById(idCat);
        } catch (Exception e) {
            log.error("get Categoria failed", e);
            throw new ZMessManager().new FindingException("Categoria");
        } finally {
        }
    ...
    public List<Categoria> findPageCategoria(String sortColumnName,
        ...
        throws Exception {
        List<Categoria> entity = null;

        try {
            entity = categoriaDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Categoria Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Categoria> findByCriteria(Object[] variables,
        ...
        try {
            list = categoriaDAO.findByCriteria(where);
        } catch (Exception e) {
