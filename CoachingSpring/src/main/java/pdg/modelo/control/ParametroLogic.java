...
public class ParametroLogic implements IParametroLogic {
    ...
    public void validateParametro(Parametro parametro)
        throws Exception {
        try {
            Set<ConstraintViolation<Parametro>> constraintViolations = validator.validate(parametro);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<Parametro> constraintViolation : constraintViolations) {
    ...
    public void saveParametro(Parametro entity) throws Exception {
        ...
        try {
            ...
            validateParametro(entity);

            if (getParametro(entity.getIdParam()) != null) {
    ...
    public void deleteParametro(Parametro entity) throws Exception {
        ...
        try {
            parametroDAO.deleteById(entity.getIdParam());
    ...
    public Parametro getParametro(Double idParam) throws Exception {
        ...
        try {
            entity = parametroDAO.findById(idParam);
        } catch (Exception e) {
